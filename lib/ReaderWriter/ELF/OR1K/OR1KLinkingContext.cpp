...
lld::elf::createOR1KLinkingContext(llvm::Triple triple) {
    if (
        triple.getArch() == llvm::Triple::or1k
            ||
...
void OR1KLinkingContext::registerRelocationNames(lld::Registry &registry) {
    registry.addKindTable(
        lld::Reference::KindNamespace::ELF,
        lld::Reference::KindArch::OR1K,
        kindStrings
    );
}


bool OR1KLinkingContext::isRelativeReloc(const lld::Reference &r) const {
...
bool OR1KLinkingContext::isCopyRelocation(const lld::Reference &r) const {
    if (r.kindNamespace() != lld::Reference::KindNamespace::ELF) {
        return false;
    }
...
bool OR1KLinkingContext::isPLTRelocation(const lld::Reference &r) const {
    if (r.kindNamespace() != lld::Reference::KindNamespace::ELF) {
        return false;
    }
